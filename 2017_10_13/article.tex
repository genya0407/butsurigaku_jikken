...
\fg{a_2}{./graph/jikken_a_2.png}{ $H=0[A/m]$の元での$I_H$と$V_H$の関係 }
\fg{a_3}{./graph/jikken_a_3.png}{ $H=20000[A/m]$の元での$I_H$と$V_H$の関係 }
% \fg{a_4}{./graph/jikken_a_4.png}{ $I_H = 10[mA]$の元での$H$と$V_H$の関係 }
